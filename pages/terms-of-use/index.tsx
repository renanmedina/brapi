    ...
    <div>
      ...
      <Layout>
        ...
        <MainLegal>
          <h2>1. Termos</h2>
          <p>
            Ao acessar ao site <a href="https://brapi.ga">Brapi</a>, concorda em
          ...
          <p>
            É concedida permissão para usar temporariamente uma cópia dos
            materiais (informações ou software) no site Brapi, apenas para
            visualização transitória pessoal. Esta é a concessão de uma licença,
          ...
          <ol>
            ...
            <li>
              ...
              software contido no site Brapi;{' '}
            </li>
            <li>
          ...
          <p>
            ...
            dessas restrições e poderá ser rescindida por Brapi a qualquer
          ...
          <ol>
            <li>
              Os materiais no site da Brapi são fornecidos 'como estão'. Brapi
            ...
            <li>
              Além disso, o Brapi não garante ou faz qualquer representação
          ...
          <h2>4. Limitações</h2>
          <p>
            Em nenhum caso o Brapi ou seus fornecedores serão responsáveis por
            ...
            da incapacidade de usar os materiais em Brapi, mesmo que Brapi ou um
            representante autorizado da Brapi tenha sido notificado oralmente ou
          ...
          <p>
            Os materiais exibidos no site da Brapi podem incluir erros técnicos,
            tipográficos ou fotográficos. Brapi não garante que qualquer
            material em seu site seja preciso, completo ou atual. Brapi pode
            fazer alterações nos materiais contidos em seu site a qualquer
            momento, sem aviso prévio. No entanto, Brapi não se compromete a
            atualizar os materiais.
          </p>
          <h2>6. Links</h2>
          <p>
            O Brapi não analisou todos os sites vinculados ao seu site e não é
            responsável pelo conteúdo de nenhum site vinculado. A inclusão de
            qualquer link não implica endosso por Brapi do site. O uso de
            qualquer site vinculado é por conta e risco do usuário.
          </p>

          <h3>Modificações</h3>
          <p>
            O Brapi pode revisar estes termos de serviço do site a qualquer
          ...
          <p>
            ...
            as leis do Brapi e você se submete irrevogavelmente à jurisdição
