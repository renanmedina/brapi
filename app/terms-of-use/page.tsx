  ...
  return (
    <div>
      <MainLegal>
        ...
        <ol>
          <li>
            Os materiais no site da Brapi são fornecidos 'como estão'. Brapi não
        ...
        <p>
          ...
          incapacidade de usar os materiais em Brapi, mesmo que Brapi ou um
        ...
        <p>
          ...
          tipográficos ou fotográficos. Brapi não garante que qualquer material
          em seu site seja preciso, completo ou atual. Brapi pode fazer
          alterações nos materiais contidos em seu site a qualquer momento, sem
          aviso prévio. No entanto, Brapi não se compromete a atualizar os
          materiais.
        </p>
        <h2>6. Links</h2>
        <p>
          ...
          qualquer link não implica endosso por Brapi do site. O uso de qualquer
        ...
        <p>
          ...
          leis do Brapi e você se submete irrevogavelmente à jurisdição
